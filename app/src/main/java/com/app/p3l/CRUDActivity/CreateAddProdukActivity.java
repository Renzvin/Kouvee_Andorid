...
public class CreateAddProdukActivity  extends AppCompatActivity {
    ...
    private RecyclerView add_produk_recycler,add_pemesanan_produk_recycler;
    private Button tambah_produk,tambah_pemesanan;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_add_produk);

        layout = (LinearLayout)findViewById(R.id.linearlayout_createaddproduk);
        spinnersupplier = (Spinner)findViewById(R.id.spinner_add_produk_supplier);
        setSpinner();
        ...
        tambah_produk= (Button)findViewById(R.id.btn_tambahproduk);
        tambah_produk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                add_produk_recycler =  (RecyclerView)dialog.findViewById(R.id.add_produk_recycler);
                ...
                add_produk_recycler.setLayoutManager(gridLayoutManager);
                add_produk_recycler.setAdapter(pemesananProdukAdapter);
                ...
                pemesananProdukAdapter.setOnItemClickListener(new PemesananProdukAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        add_pemesanan_produk_recycler = (RecyclerView)findViewById(R.id.add_pemesanan_produk_recycler);
                        ...
                        add_pemesanan_produk_recycler.setLayoutManager(mLayout);
                        add_pemesanan_produk_recycler.setAdapter(addProdukAdapter);
        ...
        tambah_pemesanan= (Button)findViewById(R.id.btn_tambahPemesanan);
        tambah_pemesanan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(addProdukAdapter.getItemCount()==0)
                {
                    Toast.makeText(CreateAddProdukActivity.this, "Jumlah item masih kosong, tidak dapat membuat pesanan", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void CreatePemesanan(String supplier_id)
    {
        String url = "http://renzvin.com/kouvee/api/pemesanan/create";
        ...
        JsonObjectRequest jsonobj = new JsonObjectRequest(Request.Method.POST, url,jsonParam1,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(CreateAddProdukActivity.this,"Sukses Membuat Data Pesanan", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CreateAddProdukActivity.this,"Gagal Membuat Data Pesanan", Toast.LENGTH_SHORT).show();
                    }
                }
        );
        queue.add(jsonobj);
    ...
    private void setSpinner() {
        ...
        RequestQueue queue = Volley.newRequestQueue(CreateAddProdukActivity.this);
        ...
        StringRequest getRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(CreateAddProdukActivity.this, android.R.layout.simple_spinner_item,temp);
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CreateAddProdukActivity.this,"Gagal Fetch Data",Toast.LENGTH_SHORT).show();
                    }
                });
