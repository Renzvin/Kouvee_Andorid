...
public class CreateTransaksiLayananActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_transaksi_layanan);
        ...
        pilih_hewan = (ImageButton) findViewById(R.id.button_pilih_hewan);

        pilih_customer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CreateTransaksiLayananActivity.this,PickCustomerActivity.class);
                startActivity(i);
            }
        });

        pilih_hewan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(CreateTransaksiLayananActivity.this,PickHewanActivity.class);
                startActivity(i);
            }
        });
            pilih_layanan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(PickHewan.tempHewan==null){
                        Toast.makeText(CreateTransaksiLayananActivity.this,"Tidak bisa memilih layanan sebelum memilih hewan",Toast.LENGTH_SHORT).show();
                    } else{
                        Intent i = new Intent(CreateTransaksiLayananActivity.this,PickLayananActivity.class);
                        startActivity(i);
                    }
        ...
        if(TempListPickLayanan.layananList!=null){
            ...
            RecyclerView.LayoutManager manager = new LinearLayoutManager(CreateTransaksiLayananActivity.this);
            ListLayananPickAdapter adapter = new ListLayananPickAdapter(CreateTransaksiLayananActivity.this, TempListPickLayanan.layananList);
            ...
            asd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (TempListPickLayanan.layananList != null && PickCustomer.tempCustomer != null && PickHewan.tempHewan != null) {
                        ...
                        Toast.makeText(CreateTransaksiLayananActivity.this, "Anda harus memiliki customer, layanan, dan hewan untuk melakukan proses transaksi", Toast.LENGTH_SHORT).show();
                    }
                }
            });
    ...
    private void createTransaksiProduk() throws JSONException {
        String url = "http://renzvin.com/kouvee/api/TransaksiLayanan/create";
        ...
        try {
            ...
            jsonParam1.put("hewan_id", Integer.toString(PickHewan.tempHewan.getId_hewan()));
        ...
        JsonObjectRequest jsonobj = new JsonObjectRequest(Request.Method.POST, url,jsonParam1,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(CreateTransaksiLayananActivity.this,"Sukses Membuat Data Produk", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CreateTransaksiLayananActivity.this,"Gagal Membuat Data Produk", Toast.LENGTH_SHORT).show();
                    }
                }
        );
        queue.add(jsonobj);
