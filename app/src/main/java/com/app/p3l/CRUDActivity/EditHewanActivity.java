...
public class EditHewanActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama = (EditText) findViewById(R.id.edit_nama_hewan);
        tanggal = (TextView) findViewById(R.id.edit_tanggal_lahir);
        spinnerjenis = (Spinner) findViewById(R.id.edit_spinner_jenis);
        spinnerukuran = (Spinner) findViewById(R.id.edit_spinner_ukuran);
        date = (Button) findViewById(R.id.edit_date);
        create = (Button) findViewById(R.id.hewan_edit);
    ...
    private void getJenis() {
        ...
        RequestQueue queue = Volley.newRequestQueue(EditHewanActivity.this);
        ...
        StringRequest getRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(EditHewanActivity.this, android.R.layout.simple_spinner_item,temp);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditHewanActivity.this,"Gagal Fetch Data",Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(EditHewanActivity.this, android.R.layout.simple_spinner_item,temp2);
                            spinnerArrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void editHewan(final String nama,final String tanggal_lahir,final String jenis,final String ukuran, final String pegawai) {
        String url = "http://renzvin.com/kouvee/api/hewan/update";
        RequestQueue queue = Volley.newRequestQueue(EditHewanActivity.this);
        StringRequest post = new StringRequest(Request.Method.POST, url,
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditHewanActivity.this,"Gagal Mengubah Hewan",Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
